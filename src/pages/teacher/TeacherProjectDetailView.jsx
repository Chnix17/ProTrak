...
import KanbanTab from '../student/components/KanbanTab';
...
const TeacherProjectDetailView = () => {
  ...
  const tabs = [
    ...
    { id: 'kanban', name: 'Kanban', description: 'Task management and progress tracking' }
  ];
          ...
          <div className="flex items-center mb-6">
            ...
            <div className="flex-1">
              ...
              <div className="mt-1 text-sm text-gray-600">
                ...
                <span className="mx-2">•</span>
                <span className="text-indigo-600 font-medium">Teacher Review Mode</span>
              </div>
            </div>
          </div>
